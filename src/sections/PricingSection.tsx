...
const pricingPlans = [
  ...
  // },
  {
    ...
    description: "Work with the Asteroid team to automate complex browser workflows",
    price: "$1,000+",
    period: "month",
    features: [
      "Provide text, SOPs, or videos—Asteroid builds your browser agent.",
      "Access to the platform workflow builder",
      "Human in the loop",
